...
public class PropertiesUtil {
    ...
    private static Class<?> getCallingClass() {
        ...
        try {
            ...
            logger.error("获取当前使用config文件地址出错", e);
        }
        return null;
    }
    ...
    private void loadProperties() {
        try {
            ...
            properties.load(new InputStreamReader(new FileInputStream(propertiefile), StandardCharsets.UTF_8));
        } catch (Exception e) {
            logger.error("loadProperties出错", e);
        }
    }
